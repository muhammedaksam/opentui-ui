...
function App() {
  ...
  const [navbarCollapsed, setNavbarCollapsed] = createSignal(false);
    ...
    >
      <AppShell.Header backgroundColor="#1a1b26" padding={1}>
        <text fg="#7aa2f7" attributes={1}>
          AppShell Solid Example - Press 'q' to quit
        </text>
      </AppShell.Header>
